...
export default {
  {
    ...
    /* faceUserDefault
     * true (default) - the front-facing camera is used if available
     * false - the rear-facing camera is used if available */
    ...
    "adanced": { // Advanced settings - See PoseNet readme for more details: https://github.com/tensorflow/tfjs-models/tree/master/posenet
